...
- [ ] No generated Terraform directories, provider lockfiles, TFLint plugin caches, state, plans, credentials, private keys, real `.tfvars`, or real `config/*.hcl` backend files are committed.
